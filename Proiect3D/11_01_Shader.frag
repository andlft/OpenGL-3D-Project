...
void main(void)
  {
    ...
    vec3 specular = specularStrength * spec * lightColor;  
    vec3 emission=vec3(0.0, 0.0, 0.0);
    vec3 result = emission+(ambient + diffuse + specular) * vec3(1.0f, 0.0f, 0.0f);
	out_Color = vec4(result, 1.0f);
    }
    ...
    vec3 specular = specularStrength * spec * lightColor;  
    vec3 emission=vec3(0.0, 0.0, 0.0);
    vec3 result = emission+(ambient + diffuse + specular) * vec3(0.0f, 0.0f, 1.0f);
	out_Color = vec4(result, 1.0f);
    }
    ...
    vec3 specular = specularStrength * spec * lightColor;  
    vec3 emission=vec3(0.0, 0.0, 0.0);
    vec3 result = emission+(ambient + diffuse + specular) * vec3(1.0f, 1.0f, 0.0f);
	out_Color = vec4(result, 1.0f);
    }
